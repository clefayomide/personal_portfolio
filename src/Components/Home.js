    ...
    <section className="home">
      <div className="home-page-content-container">
        <div className="greeting">
          <PageRouteAndHeadingText innerText="Hello" />
          <div className="name-job-title-container">
            <p className="name">
              I'M VICTOR AYOMIDE <br /> OLORUNFEMI
            </p>
        ...
        <div className="socials">
          <div className="github">
            <a href="https://github.com/clefayomide" className="github-link">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="23"
                height="23"
          ...
          <div className="twiiter">
            <a
              href="https://www.twitter.com/olorunfemivic18"
