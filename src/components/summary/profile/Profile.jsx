...
export const Designation = () => {
	return (
		<div className={styles.designation_animate}>
			<div className={styles.designation_title}>Fullstack Engineer</div>
	...
	return (
		<div className={styles.intro_container}>
			...
			<p className={styles.intro_text}>
				My name is Victor, I am a Fullstack Software Engineer based in Nigeria.
				I am currently building amazing FinTech solutions and products that
				delights the end users{" "}
